...
if (bulkEditor.length) {
    ...
    // Fungsi untuk memeriksa apakah tombol "Terapkan" harus diaktifkan
    ...
    // Tambahkan event listener untuk memanggil fungsi di atas
    ...
    applyBtn.on('click', function (e) {
        ...
        .always(function () {
            // Tombol akan di-enable lagi setelah pengecekan state
            checkBulkEditState(); 
            spinner.removeClass('is-active');
        });
    });
