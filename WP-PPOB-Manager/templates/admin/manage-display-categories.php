...
<div class="wrap">
    ...
    <p>Gunakan antarmuka di sebelah kanan untuk menyusun urutan dan hierarki kategori dengan *drag-and-drop*. Klik "Edit" untuk mengubah detail di form sebelah kiri.</p>
    ...
    <div id="col-container" class="wp-clearfix">
                ...
                <form method="post" action="">
                    ...
                    <div class="form-field">
                        ...
                        <div class="wppob-product-checkbox-container">
                            <?php if (!empty($ppob_products)): foreach($ppob_products as $product): $product_id = $product->get_id(); $is_checked = in_array($product_id, $selected_products); ?>
        ...
        <div id="col-right">
            <div class="col-wrap">
                ...
                <p class="description">Gunakan ikon <span class="dashicons dashicons-minus"></span> untuk membuka/menutup sub-kategori. Perubahan urutan disimpan otomatis.</p>
                <hr>
